    ...
    public class UrunlerController : Controller
    {
        ...
        public IActionResult Create(UrunModel urun, IFormFile image)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", $"Dosya yüklenemedi: Uzantılar {AppSettings.AcceptedImageExtensions} biri olmalı ve dosya boyutu maksimum {AppSettings.AcceptedImageLength} MB olmalıdır!");
                }
                else
                {
